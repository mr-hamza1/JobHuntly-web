...
import { Box, Stack, Typography, Grid, Card, CardContent, Chip, Avatar, Link as MuiLink } from "@mui/material";
...
export default function Fourth() {
  return (
    <Box sx={{ pt: 8 }} pr={{xs:0, md:"6.5rem"}} pl={{xs:3 , md:"6.5rem"}} display={{xs:"none",md:"block"}} >
      {/* Header */}
            ...
            >
              <CardContent sx={{ p: 3, height: "100%" }}>
                <Stack spacing={2} sx={{ height: "100%" }}>
                  {/* Header with logo and Full Time badge */}
